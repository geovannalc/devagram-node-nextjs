...
export const conectarMongoDB = (handler : NextApiHandler) =>
    ...
    // para o endpoint ou proximo middlewaee
    ...
    mongoose.connection.on('error', error => console.log(`Ocorre erro ao conectar no banco: ${error}`));
    await mongoose.connect(DB_CONEXAO_STRING);
    
    // agora posso seguir para endpoint, pois estou conectado no banco
    return handler(req, res);
}